...
def Criar_conta_TK():
    ...
    btnCriarConta= Button(CriarWindow, text = "Login", width=15, height=2,font = ("Helvetica", "15"),command = lambda: criaConta(txtUserCriar.get(), txtPassCriar.get(), txtPassCriar_Confirmar.get(),CriarWindow))
...
btnJogar = Button(PanelStatus, text = "Ver Atividades", width = 11, height = 4,font = ("Helvetica", "10"))
btnJogar.place(x=270, y=12)
